...
export const optimizedImageMap: Record<string, OptimizedImageVariant[]> = {
  ...
  '/Emergency-Tree-Service-Always-Ready.jpg': [
    ...
    { src: '/optimized/Emergency-Tree-Service-Always-Ready-1024w.avif', width: 1024, format: 'avif' },
    ...
    { src: '/optimized/Emergency-Tree-Service-Always-Ready-1024w.webp', width: 1024, format: 'webp' },
    { src: '/optimized/Emergency-Tree-Service-Always-Ready-optimized.jpg', width: 1215, format: 'jpg' },
  ],
  '/Emergency-Tree-Service-Equipment.jpg': [
    ...
    { src: '/optimized/Emergency-Tree-Service-Equipment-optimized.jpg', width: 1215, format: 'jpg' },
  ],
}
