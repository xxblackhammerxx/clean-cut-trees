...
export const metadata: Metadata = {
  title: 'Demo - Clean Cuts Trees | Clean Cuts Trees',
  description: 'Learn about Demo - Clean Cuts Trees at Clean Cuts Trees',
          ...
          <div className="page-layout">
            <div className="page-main">
              <header className="page-header">
                <h1 className="page-title">Demo - Clean Cuts Trees</h1>
              </header>
