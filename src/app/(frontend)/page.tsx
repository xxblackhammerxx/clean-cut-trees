  ...
  return (
    <>
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              ...
              comprehensive tree services. Our certified arborists offer emergency tree removal,
              tree trimming, pruning tree services, and complete tree care solutions for residential
        ...
        <div className="container">
          ...
          <div className="service-details">
            <div className="service-detail">
              ...
              <p>
                Our emergency tree service operates 24/7 to handle tree emergencies, fallen trees,
                and dangerous tree situations. Whether you need emergency tree removal after a storm
                or immediate tree care for damaged trees, our professional tree service team
                responds quickly with the right equipment and expertise. We provide emergency tree
                services throughout your yard and property, ensuring safe tree removal and cleanup.
              </p>
            </div>
            ...
            <div className="service-detail">
              ...
              <p>
                Our tree removal services include complete tree removal, stump removal, and branch
                removal for trees of all sizes. From small trees in tight spaces to large tree
                removal projects, our professional tree removal company handles difficult jobs with
                precision. We provide free estimates for all tree removal services and ensure your
                yard is left clean after every tree removal project.
              </p>
            </div>
            ...
            <div className="service-detail">
              ...
              <p>
                Regular tree care is essential for healthy trees and safe properties. Our tree care
                services include professional tree trimming, pruning tree operations, tree risk
                assessment, and ongoing tree maintenance. Proper trimming not only improves tree
                health but also prevents branches from becoming hazardous during storms. Our tree
                care experts assess each tree&apos;s needs and provide customized tree services.
              </p>
            </div>
            ...
            <div className="service-detail">
              ...
              <p>
                As a leading tree service company, we combine years of experience with professional
                equipment to deliver superior tree services. Our team provides tree removal, tree
                care, emergency tree service, and tree emergency response with a focus on safety and
                customer satisfaction. Every tree service includes a free estimate, and we work with
                insurance companies for storm damage claims.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <p>
                ...
                tree care to stay healthy and strong. For example, tree limbs and stray branches
                need to be trimmed through professional trimming services to keep their shape and
                ensure that they don&apos;t obstruct views and power lines. Falling branches and
                even entire trees can damage your family and property, which is why emergency tree
                service and tree removal are critical services.
              </p>
              <p>
                ...
                inspect, prune, and trim the trees around their property as well as provide
                emergency tree removal, professional tree services, tree care, and removal services
                for trees, shrubs, and bushes when needed. Our company provides comprehensive tree
                services with free estimates for every project.
              </p>
      ...
      <section className="service-areas">
        <div className="container">
          <h2 className="section-title">
            We are Open 24 Hours for Storm and Tree Services in Davis, Weber, and Salt Lake County
        ...
        <div className="container">
          ...
          <div className="faq-grid">
            <div className="faq-item">
              ...
              <p>
                Your trees are important and should receive proper tree care. If you let them grow
                too thick, they could fall during storms! Professional tree trimming is a great way
                to keep them healthy and strong. Regular trimming and pruning tree services help
                maintain tree health, prevent branches from becoming hazardous, and protect your
                yard and property. If tree branches get too thick, they cause problems for
            ...
            <div className="faq-item">
              ...
              <p>
                Most trees should receive professional trimming services every 3-5 years, depending
                on the tree species and growth rate. Fast-growing trees may need annual tree care
                and trimming, while slower-growing trees can go longer between professional tree
                services. Our tree service company provides free estimates to assess your
                trees&apos; trimming needs and create a tree care schedule that keeps your trees
                healthy and your yard safe.
              </p>
            </div>
            <div className="faq-item">
              ...
              <p>
                ...
                plumbing. Our professional tree service experts can assess whether tree removal or
                pruning tree branches is the best solution for your situation. We provide tree risk
                assessment and free estimates for tree removal services to help protect your
                property and ensure your yard remains safe.
              </p>
            </div>
            <div className="faq-item">
              ...
              <p>
                ...
                debris after severe weather. Our emergency tree service operates 24/7 to provide
                rapid tree emergency response for dangerous tree situations. We handle difficult
                jobs including emergency tree removal, storm cleanup, and emergency tree care to
                protect your property and ensure your yard is safe after tree emergencies.
              </p>
            </div>
          </div>
          <div
