...
export const metadata: Metadata = {
  ...
  description: 'Whether you need to free up space in a small yard at your home in or an expansive area adjacent to your commercial property in Kaysville or Layton, UT, Clean',
  keywords: 'tree service, Clean Cuts Trees, Utah',
}

export default function Services/landClearingPage() {
...
Site Survey: Comprehensive assessment of terrain, vegetation, and obstacles
Environmental Review: Checking for protected species and sensitive areas
Permit Research: Identifying required permits and regulatory compliance
Access Planning: Determining equipment access routes and staging areas
Safety Evaluation: Identifying potential hazards and safety protocols
...
Whether you're planning a small residential project or a large commercial development, we have the expertise and equipment to complete your land clearing project safely, efficiently, and in compliance with all applicable regulations.</p>
    </>
              </div>
